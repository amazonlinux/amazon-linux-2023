...
Amazon Linux 2022 was updated in preview July 19, 2022\.
...
|  `aws-c-cal-0.5.12-7.amzn2022 ` \-> `aws-c-cal-0.5.12-7.amzn2022.0.1`  | 
...
|  `gtk3-3.24.30-4.amzn2022 ` \-> `gtk3-3.24.30-4.amzn2022.0.1`  | 
...
|  `php-8.1.7-1.amzn2022.0.4 ` \-> `php-8.1.7-1.amzn2022.0.5`  | 
...
|  `systemtap-4.7-1.amzn2022.0.1 ` \-> `systemtap-4.7-1.amzn2022.0.2`  | 
...
|  `openssl1.1-1:1.1.1l-2.amzn2022.0.2`  | 
...
|   `java-1.8.0-amazon-corretto`   |   `1.8.0_342.b07-2.amzn2022`   | 
|   `java-11-amazon-corretto`   |   `11.0.16+8-1.amzn2022`   | 
|   `java-17-amazon-corretto`   |   `17.0.4+8-1.amzn2022.1`   | 
...
|   `postgresql13`   |   `13.7-1.amzn2022.0.3`   | 
...
There are 1328 updated packages in Amazon Linux 2022\.
...
|  `amazon-efs-utils`  |  `1.33.1-1.amzn2`  |  `1.33.2-1.amzn2022`  | 
|  `amazon-ssm-agent`  |  `3.1.1188.0-1.amzn2`  |  `3.1.1575.0-1.amzn2022`  | 
...
|  `binutils`  |  `2.29.1-31.amzn2`  |  `2.38-15.amzn2022.0.1`  | 
...
|  `ec2-instance-connect`  |  `1.1-15.amzn2`  |  `1.1-19.amzn2022`  | 
...
|  `gcc`  |  `7.3.1-15.amzn2`  |  `11.3.1-2.amzn2022.0.3`  | 
...
|  `git`  |  `2.32.0-1.amzn2.0.1`  |  `2.36.1-1.amzn2022.0.4`  | 
...
|  `glibc`  |  `2.26-58.amzn2`  |  `2.34-38.amzn2022.0.2`  | 
...
|  `golang`  |  `1.16.15-1.amzn2.0.1`  |  `1.18.3-2.amzn2022.0.1`  | 
...
|  `httpd`  |  `2.4.53-1.amzn2`  |  `2.4.54-3.amzn2022.0.1`  | 
...
|  `java-1.8.0-amazon-corretto`  |  `1.8.0_342.b07-1.amzn2`  |  `1.8.0_342.b07-2.amzn2022`  | 
|  `java-11-amazon-corretto`  |  `11.0.15+9-1.amzn2`  |  `11.0.16+8-1.amzn2022`  | 
|  `java-17-amazon-corretto`  |  `17.0.3+6-1.amzn2.1`  |  `17.0.4+8-1.amzn2022.1`  | 
...
|  `kernel`  |  `4.14.281-212.502.amzn2`  |  `5.15.54-25.126.amzn2022`  | 
|  `kernel`  |  `5.10.130-118.517.amzn2`  |  `5.15.54-25.126.amzn2022`  | 
|  `kernel`  |  `5.4.204-113.362.amzn2`  |  `5.15.54-25.126.amzn2022`  | 
|  `kernel`  |  `5.10.130-118.517.amzn2`  |  `5.15.54-25.126.amzn2022`  | 
|  `kernel`  |  `5.15.54-25.126.amzn2`  |  `5.15.54-25.126.amzn2022`  | 
...
|  `php`  |  `5.4.16-46.amzn2.0.2`  |  `8.1.7-1.amzn2022.0.5`  | 
|  `php`  |  `7.4.30-1.amzn2`  |  `8.1.7-1.amzn2022.0.5`  | 
|  `php`  |  `8.0.20-1.amzn2`  |  `8.1.7-1.amzn2022.0.5`  | 
...
|  `postgresql`  |  `9.2.24-6.amzn2`  |  `13.7-1.amzn2022.0.3`  | 
|  `postgresql`  |  `9.6.22-1.amzn2.0.1`  |  `13.7-1.amzn2022.0.3`  | 
|  `postgresql`  |  `10.17-1.amzn2.0.2`  |  `13.7-1.amzn2022.0.3`  | 
|  `postgresql`  |  `11.12-1.amzn2.0.1`  |  `13.7-1.amzn2022.0.3`  | 
|  `postgresql`  |  `12.7-1.amzn2.0.1`  |  `13.7-1.amzn2022.0.3`  | 
|  `postgresql`  |  `13.3-2.amzn2.0.1`  |  `13.7-1.amzn2022.0.3`  | 
|  `postgresql`  |  `14.1-3.amzn2.0.1`  |  `13.7-1.amzn2022.0.3`  | 
...
|  `python-rpm-generators`  |  `10-4.amzn2.0.1`  |  `12-15.amzn2022.0.1`  | 
...
|  `system-release`  |  `2-14.amzn2`  |  `2022.0.20220719-0.amzn2022`  | 
|  `systemd`  |  `219-78.amzn2.0.18`  |  `250.7-1.amzn2022.0.2`  | 
|  `systemtap`  |  `4.4-1.amzn2.0.2`  |  `4.7-1.amzn2022.0.2`  | 
...
|  `tomcat`  |  `8.5.79-1.amzn2.0.1`  |  `9.0.59-1.amzn2022`  | 
...
|  `udisks2`  |  `2.7.3-9.amzn2.0.1`  |  `2.9.4-1.amzn2022.0.1`  | 
...
|  `vim`  |  `8.2.4857-1.amzn2.0.1`  |  `8.2.5172-1.amzn2022.0.1`  | 
...
There are 884 packages new for Amazon Linux 2022\.
...
There are 1554 packages that were in Amazon Linux 2 that are not a part of Amazon Linux 2022\.
