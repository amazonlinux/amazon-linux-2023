...
|   `memcached`   |   `1.6.9-3.amzn2022.0.1`   | 
...
|   `mongo-c-driver`   |   `1.19.2-1.amzn2022.0.1`   | 
...
|   `openssh`   |   `8.6p1-5.amzn2022.0.1`   | 
|   `openssl`   |   `3.0.0-1.amzn2022.0.1`   | 
|   `openssl-pkcs11`   |   `0.4.11-8.amzn2022`   | 
|   `openssl1.1`   |   `1.1.1l-2.amzn2022.0.1`   | 
|   `openwsman`   |   `2.6.8-19.amzn2022.0.1`   | 
...
|   `perl-Convert-Bencode_XS`   |   `0.06-31.amzn2022`   | 
...
|   `perl-Crypt-Blowfish_PP`   |   `1.12-26.amzn2022`   | 
...
|   `perl-DBIx-XHTML_Table`   |   `1.49-14.amzn2022`   | 
...
|   `postfix`   |   `3.6.2-5.amzn2022.0.1`   | 
|   `postgresql10`   |   `10.18-1.amzn2022.0.3`   | 
|   `postgresql11`   |   `11.13-1.amzn2022.0.2`   | 
|   `postgresql12`   |   `12.10-1.amzn2022.0.1`   | 
|   `postgresql13`   |   `13.5-1.amzn2022.0.1`   | 
...
|   `pulseaudio`   |   `14.2-3.amzn2022.0.2`   | 
|   `py3c`   |   `1.3-3.amzn2022`   | 
...
|   `python-ipython_genutils`   |   `0.1.0-24.amzn2022`   | 
...
|   `python-setuptools_scm`   |   `5.0.1-1.amzn2022`   | 
|   `python-setuptools_scm_git_archive`   |   `1.1-4.amzn2022`   | 
|   `python-should_dsl`   |   `2.1.2-5.amzn2022`   | 
...
|   `python-sphinx_lv2_theme`   |   `1.0.0-3.amzn2022`   | 
...
|   `python2.7`   |   `2.7.18-15.amzn2022.0.1`   | 
...
|   `python3.8`   |   `3.8.12-1.amzn2022.0.1`   | 
|   `python3.9`   |   `3.9.8-1.amzn2022.0.1`   | 
...
|   `qt5-qtbase`   |   `5.15.2-26.amzn2022.0.1`   | 
...
|   `rubygem-connection_pool`   |   `2.2.3-2.amzn2022`   | 
...
|   `rubygem-cucumber-tag_expressions`   |   `2.0.2-3.amzn2022`   | 
...
|   `rubygem-domain_name`   |   `0.5.20190701-4.amzn2022`   | 
...
|   `rubygem-eventmachine`   |   `1.2.7-14.amzn2022.0.1`   | 
...
|   `rubygem-http_parser.rb`   |   `0.6.0-21.amzn2022`   | 
|   `rubygem-httpclient`   |   `2.8.3-4.amzn2022`   | 
|   `rubygem-i18n`   |   `1.8.7-2.amzn2022`   | 
|   `rubygem-image_processing`   |   `1.11.0-3.amzn2022`   | 
...
|   `rubygem-method_source`   |   `1.0.0-2.amzn2022`   | 
|   `rubygem-mimemagic`   |   `0.3.2-7.amzn2022`   | 
|   `rubygem-mini_magick`   |   `4.11.0-2.amzn2022`   | 
|   `rubygem-mini_mime`   |   `1.1.0-2.amzn2022`   | 
...
|   `rubygem-multi_json`   |   `1.15.0-2.amzn2022`   | 
|   `rubygem-multi_test`   |   `0.1.2-11.amzn2022`   | 
...
|   `rubygem-power_assert`   |   `1.2.0-202.amzn2022.0.1`   | 
|   `rubygem-prawn`   |   `2.4.0-3.amzn2022`   | 
|   `rubygem-pry`   |   `0.13.1-5.amzn2022`   | 
|   `rubygem-public_suffix`   |   `4.0.6-2.amzn2022`   | 
...
|   `rubygem-regexp_parser`   |   `2.0.0-2.amzn2022`   | 
|   `rubygem-regexp_property_values`   |   `1.0.0-3.amzn2022`   | 
...
|   `rubygem-rspec-collection_matchers`   |   `1.2.0-2.amzn2022`   | 
...
|   `rubygem-test_construct`   |   `2.0.2-2.amzn2022`   | 
|   `rubygem-test_declarative`   |   `0.0.5-19.amzn2022`   | 
|   `rubygem-thor`   |   `1.1.0-2.amzn2022`   | 
|   `rubygem-thread_order`   |   `1.1.1-5.amzn2022`   | 
...
|   `rubygem-unf_ext`   |   `0.0.8-1.amzn2022`   | 
...
|   `rust-ansi_term`   |   `0.12.1-4.amzn2022`   | 
|   `rust-ansi_term0.11`   |   `0.11.0-6.amzn2022`   | 
...
|   `rust-arg_enum_proc_macro`   |   `0.3.1-1.amzn2022`   | 
|   `rust-arrayvec`   |   `0.7.2-25.amzn2022`   | 
|   `rust-arrayvec0.5`   |   `0.5.2-3.amzn2022`   | 
|   `rust-asn1`   |   `0.8.7-10.amzn2022`   | 
|   `rust-asn1_derive`   |   `0.8.7-10.amzn2022`   | 
|   `rust-assert-impl`   |   `0.1.3-3.amzn2022`   | 
|   `rust-assert_approx_eq`   |   `1.1.0-2.amzn2022`   | 
|   `rust-assert_cli`   |   `0.6.3-5.amzn2022`   | 
|   `rust-assert_cmd`   |   `2.0.2-14.amzn2022`   | 
|   `rust-assert_matches`   |   `1.5.0-1.amzn2022`   | 
...
|   `rust-bytemuck_derive`   |   `1.0.1-2.amzn2022`   | 
...
|   `rust-clap_derive`   |   `3.0.0~beta.5-6.amzn2022`   | 
|   `rust-cmake`   |   `0.1.46-30.amzn2022`   | 
|   `rust-color_quant`   |   `1.1.0-2.amzn2022`   | 
|   `rust-colored1`   |   `1.9.3-2.amzn2022`   | 
|   `rust-console`   |   `0.14.1-1.amzn2022`   | 
|   `rust-console_error_panic_hook`   |   `0.1.7-5.amzn2022`   | 
|   `rust-const_fn`   |   `0.4.8-1.amzn2022`   | 
|   `rust-cpp_demangle`   |   `0.3.3-29.amzn2022`   | 
...
|   `rust-derive_arbitrary`   |   `1.0.0-1.amzn2022`   | 
|   `rust-derive_arbitrary0.4`   |   `0.4.7-1.amzn2022`   | 
...
|   `rust-encoding_rs`   |   `0.8.29-41.amzn2022`   | 
|   `rust-enum-iterator`   |   `0.6.0-2.amzn2022`   | 
|   `rust-enum-iterator-derive`   |   `0.6.0-2.amzn2022`   | 
|   `rust-env_logger`   |   `0.9.0-44.amzn2022`   | 
|   `rust-env_logger0.6`   |   `0.6.2-4.amzn2022`   | 
|   `rust-env_logger0.7`   |   `0.7.1-2.amzn2022`   | 
|   `rust-env_logger0.8`   |   `0.8.4-2.amzn2022`   | 
...
|   `rust-failure_derive`   |   `0.1.8-3.amzn2022`   | 
...
|   `rust-form_urlencoded`   |   `1.0.1-1.amzn2022`   | 
...
|   `rust-interpolate_name`   |   `0.2.3-4.amzn2022`   | 
...
|   `rust-lock_api`   |   `0.4.5-28.amzn2022`   | 
...
|   `rust-miniz_oxide`   |   `0.4.4-1.amzn2022`   | 
|   `rust-miniz_oxide0.3`   |   `0.3.7-2.amzn2022`   | 
...
|   `rust-num_cpus`   |   `1.13.0-3.amzn2022`   | 
|   `rust-object`   |   `0.26.2-33.amzn2022`   | 
|   `rust-once_cell`   |   `1.8.0-1.amzn2022`   | 
...
|   `rust-os_str_bytes`   |   `5.0.0-6.amzn2022`   | 
|   `rust-owning_ref`   |   `0.4.1-3.amzn2022`   | 
|   `rust-packaging`   |   `18-1.amzn2022`   | 
|   `rust-parking_lot`   |   `0.11.1-4.amzn2022`   | 
|   `rust-parking_lot_core`   |   `0.8.3-1.amzn2022`   | 
|   `rust-paste`   |   `1.0.6-30.amzn2022`   | 
|   `rust-pathfinder_geometry`   |   `0.5.1-2.amzn2022`   | 
|   `rust-pathfinder_simd`   |   `0.5.1-1.amzn2022`   | 
|   `rust-peeking_take_while`   |   `0.1.2-10.amzn2022`   | 
|   `rust-percent-encoding`   |   `2.1.0-4.amzn2022`   | 
|   `rust-permutohedron`   |   `0.2.4-10.amzn2022`   | 
|   `rust-pest`   |   `2.1.3-3.amzn2022`   | 
|   `rust-pest_generator`   |   `2.1.3-3.amzn2022`   | 
|   `rust-pest_meta`   |   `2.1.3-3.amzn2022`   | 
|   `rust-petgraph`   |   `0.5.1-3.amzn2022`   | 
|   `rust-phf`   |   `0.8.0-3.amzn2022`   | 
|   `rust-phf_codegen`   |   `0.8.0-3.amzn2022`   | 
|   `rust-phf_generator`   |   `0.8.0-3.amzn2022`   | 
|   `rust-phf_shared`   |   `0.8.0-3.amzn2022`   | 
...
|   `rust-pretty_assertions`   |   `0.7.2-1.amzn2022`   | 
|   `rust-pretty_assertions0.6`   |   `0.6.1-1.amzn2022`   | 
|   `rust-pretty_env_logger`   |   `0.4.0-3.amzn2022`   | 
...
|   `rust-quickcheck_macros`   |   `1.0.0-7.amzn2022`   | 
...
|   `rust-rand_chacha`   |   `0.3.1-18.amzn2022`   | 
|   `rust-rand_chacha0.1`   |   `0.1.1-5.amzn2022`   | 
|   `rust-rand_chacha0.2`   |   `0.2.2-2.amzn2022`   | 
|   `rust-rand_core`   |   `0.6.3-1.amzn2022`   | 
|   `rust-rand_core0.3`   |   `0.3.1-9.amzn2022`   | 
|   `rust-rand_core0.4`   |   `0.4.2-4.amzn2022`   | 
|   `rust-rand_core0.5`   |   `0.5.1-2.amzn2022`   | 
|   `rust-rand_hc`   |   `0.3.1-1.amzn2022`   | 
|   `rust-rand_hc0.1`   |   `0.1.0-4.amzn2022`   | 
|   `rust-rand_isaac0.1`   |   `0.1.1-4.amzn2022`   | 
|   `rust-rand_jitter0.1`   |   `0.1.4-4.amzn2022`   | 
|   `rust-rand_os0.1`   |   `0.1.3-4.amzn2022`   | 
|   `rust-rand_pcg`   |   `0.3.1-1.amzn2022`   | 
|   `rust-rand_pcg0.1`   |   `0.1.2-5.amzn2022`   | 
|   `rust-rand_pcg0.2`   |   `0.2.1-2.amzn2022`   | 
|   `rust-rand_xorshift`   |   `0.3.0-1.amzn2022`   | 
|   `rust-rand_xorshift0.1`   |   `0.1.1-4.amzn2022`   | 
|   `rust-rand_xorshift0.2`   |   `0.2.0-1.amzn2022`   | 
|   `rust-rand_xoshiro`   |   `0.6.0-17.amzn2022`   | 
...
|   `rust-remove_dir_all`   |   `0.7.0-1.amzn2022.0.1`   | 
|   `rust-reqwest`   |   `0.11.4-1.amzn2022`   | 
|   `rust-resize`   |   `0.4.0-3.amzn2022`   | 
|   `rust-rle-decode-fast`   |   `1.0.1-3.amzn2022`   | 
|   `rust-rust_hawktracer`   |   `0.7.0-3.amzn2022`   | 
|   `rust-rust_hawktracer_normal_macro`   |   `0.4.1-3.amzn2022`   | 
|   `rust-rust_hawktracer_proc_macro`   |   `0.4.1-3.amzn2022`   | 
|   `rust-rust_hawktracer_sys`   |   `0.4.2-16.amzn2022`   | 
...
|   `rust-rustc_version`   |   `0.4.0-21.amzn2022`   | 
|   `rust-rustc_version0.3`   |   `0.3.3-2.amzn2022`   | 
...
|   `rust-scan_fmt`   |   `0.2.6-1.amzn2022`   | 
|   `rust-scoped-tls`   |   `1.0.0-6.amzn2022`   | 
|   `rust-scoped_threadpool`   |   `0.1.9-9.amzn2022`   | 
...
|   `rust-serde_bytes`   |   `0.11.5-3.amzn2022`   | 
|   `rust-serde_cbor`   |   `0.11.2-22.amzn2022`   | 
|   `rust-serde_derive`   |   `1.0.130-102.amzn2022`   | 
|   `rust-serde_ignored`   |   `0.1.2-3.amzn2022`   | 
|   `rust-serde_json`   |   `1.0.70-78.amzn2022`   | 
|   `rust-serde_stacker`   |   `0.1.4-3.amzn2022`   | 
|   `rust-serde_test`   |   `1.0.130-99.amzn2022`   | 
|   `rust-serde_urlencoded`   |   `0.7.0-2.amzn2022`   | 
|   `rust-serial_test`   |   `0.5.1-2.amzn2022`   | 
|   `rust-serial_test_derive`   |   `0.5.1-2.amzn2022`   | 
...
|   `rust-simd_helpers`   |   `0.1.0-4.amzn2022`   | 
...
|   `rust-stable_deref_trait`   |   `1.2.0-4.amzn2022`   | 
|   `rust-stacker`   |   `0.1.14-1.amzn2022`   | 
|   `rust-standback`   |   `0.2.17-1.amzn2022`   | 
|   `rust-static_assertions`   |   `1.1.0-5.amzn2022`   | 
|   `rust-string_cache`   |   `0.8.2-15.amzn2022`   | 
|   `rust-string_cache_codegen`   |   `0.5.1-4.amzn2022`   | 
...
|   `rust-strum_macros`   |   `0.21.1-1.amzn2022`   | 
|   `rust-sval`   |   `1.0.0~alpha.5-1.amzn2022`   | 
|   `rust-sval_derive`   |   `1.0.0~alpha.5-1.amzn2022`   | 
|   `rust-sval_json`   |   `1.0.0_alpha.5-1.amzn2022.0.1`   | 
...
|   `rust-terminal_size`   |   `0.1.17-1.amzn2022`   | 
...
|   `rust-thread_local`   |   `1.1.3-1.amzn2022`   | 
...
|   `rust-tinyvec_macros`   |   `0.1.0-2.amzn2022`   | 
...
|   `rust-v_frame`   |   `0.2.5-8.amzn2022`   | 
|   `rust-value-bag`   |   `1.0.0_alpha.7-1.amzn2022.0.1`   | 
|   `rust-vec_map`   |   `0.8.2-3.amzn2022`   | 
|   `rust-vergen`   |   `5.1.17-13.amzn2022`   | 
|   `rust-vergen3`   |   `3.2.0-2.amzn2022`   | 
|   `rust-version-compare`   |   `0.0.11-2.amzn2022`   | 
|   `rust-version_check`   |   `0.9.3-1.amzn2022`   | 
|   `rust-vte`   |   `0.10.1-1.amzn2022`   | 
|   `rust-vte_generate_state_changes`   |   `0.1.1-2.amzn2022`   | 
...
|   `sendmail`   |   `8.16.1-7.amzn2022.0.1`   | 
...
|   `w3m`   |   `0.5.3-50.git20210102.amzn2022.0.1`   | 
...
|   `xemacs`   |   `21.5.34-39.20200331hge2ac728aa576.amzn2022.0.1`   | 
...
|   `xmlrpc-c`   |   `1.51.0-12.amzn2022.0.1`   | 
|   `xmlsec1`   |   `1.2.29-3.amzn2022.0.1`   | 
...
|   `xorg-x11-server`   |   `1.20.11-1.amzn2022.0.1`   | 
...
There are 1338 packages that were in Amazon Linux 2 that are not a part of Amazon Linux 2022\.
...
There are 1368 updated packages in Amazon Linux 2022\.
...
|   `amazon-efs-utils`   |   `1.32.1-2.amzn2`   |   `1.32.1-1.amzn2022`   | 
...
|   `createrepo_c`   |   `0.12.2-2.amzn2.0.2`   |   `0.17.5-1.amzn2022.0.1`   | 
...
|   `curl`   |   `7.79.1-2.amzn2.0.1`   |   `7.79.1-2.amzn2022`   | 
...
|   `dhcp`   |   `4.2.5-77.amzn2.1.6`   |   `4.4.2-11.b1.amzn2022`   | 
...
|   `ec2-instance-connect`   |   `1.1-15.amzn2`   |   `1.1-16.amzn2022`   | 
...
|   `expat`   |   `2.1.0-12.amzn2.0.4`   |   `2.4.7-1.amzn2022`   | 
...
|   `gcc`   |   `7.3.1-14.amzn2`   |   `11.2.1-10.amzn2022.0.1`   | 
...
|   `glibc`   |   `2.26-58.amzn2`   |   `2.34-8.amzn2022`   | 
...
|   `gnu-efi`   |   `3.0.8-4.amzn2.0.1`   |   `3.0.11-7.1.amzn2022`   | 
...
|   `go-rpm-macros`   |   `3.0.15-23.amzn2.0.1`   |   `3.0.10-1.amzn2022`   | 
|   `gobject-introspection`   |   `1.56.1-1.amzn2`   |   `1.68.0-4.amzn2022`   | 
|   `golang`   |   `1.16.15-1.amzn2.0.1`   |   `1.16.15-1.amzn2022.0.1`   | 
...
|   `grub2`   |   `2.06-9.amzn2.0.1`   |   `2.06-22.amzn2022.0.1`   | 
...
|   `httpd`   |   `2.4.53-1.amzn2`   |   `2.4.53-3.amzn2022.0.1`   | 
...
|   `kernel`   |   `4.14.276-211.499.amzn2`   |   `5.15.29-16.111.amzn2022`   | 
|   `kexec-tools`   |   `2.0.23-1.amzn2.0.2`   |   `2.0.23-4.amzn2022`   | 
...
|   `libarchive`   |   `3.1.2-14.amzn2`   |   `3.5.3-1.amzn2022`   | 
|   `libart_lgpl`   |   `2.3.21-10.amzn2.0.2`   |   `2.3.21-25.amzn2022`   | 
...
|   `libtiff`   |   `4.0.3-35.amzn2.0.1`   |   `4.3.0-6.amzn2022`   | 
...
|   `maven-shared-utils`   |   `0.4-4.amzn2`   |   `3.2.1-0.8.amzn2022.0.1`   | 
...
|   `microcode_ctl`   |   `2.1-47.amzn2.0.11`   |   `2.1-46.amzn2022`   | 
|   `mod_fcgid`   |   `2.3.9-6.amzn2`   |   `2.3.9-24.amzn2022`   | 
|   `mod_http2`   |   `1.15.19-1.amzn2.0.1`   |   `1.15.24-1.amzn2022.0.1`   | 
|   `mod_security`   |   `2.9.3-1.amzn2.0.1`   |   `2.9.3-10.amzn2022`   | 
|   `mod_security_crs`   |   `2.2.9-1.amzn2`   |   `3.3.0-1.amzn2022`   | 
...
|   `openldap`   |   `2.4.44-23.amzn2.0.3`   |   `2.4.57-6.amzn2022.0.1`   | 
...
|   `qemu`   |   `3.1.0-8.amzn2.0.8`   |   `6.1.0-14.amzn2022.0.1`   | 
...
|   `rpm`   |   `4.11.3-48.amzn2.0.2`   |   `4.16.1.3-1.amzn2022.0.1`   | 
...
|   `selinux-policy`   |   `3.13.1-192.amzn2.6.8`   |   `34.21-1.amzn2022`   | 
...
|   `tcp_wrappers`   |   `7.6-77.amzn2.0.2`   |   `7.6-97.amzn2022`   | 
...
|   `texlive`   |   `2012-38.20130427_r30134.amzn2.0.5`   |   `2020-38.amzn2022.0.1`   | 
...
|   `tomcat`   |   `7.0.76-10.amzn2.0.2`   |   `9.0.59-1.amzn2022`   | 
...
|   `util-linux`   |   `2.30.2-2.amzn2.0.7`   |   `2.36.2-1.amzn2022`   | 
...
|   `vim`   |   `8.2.4428-1.amzn2.0.3`   |   `8.2.4314-1.amzn2022`   | 
...
|   `zlib`   |   `1.2.7-19.amzn2.0.1`   |   `1.2.11-27.amzn2022`   | 
