...
## Major updates<a name="major-updates-20221101"></a>
...
## Major changes from the first Tech Preview release to RC0<a name="major-changes-20221101"></a>
...
| `poppler` | `21.01.0-7.amzn2022.0.2` | 
...
| `protobuf-c` | `1.3.3-7.amzn2022.0.1` | 
...
| `python-bottle` | `0.12.18-3.amzn2022.0.1` | 
...
| `python-jwt` | `1.7.1-11.amzn2022.0.1` | 
...
| `python-pip` | `21.3.1-2.amzn2022.0.3` | 
...
| `python-waitress` | `1.4.4-3.amzn2022.0.1` | 
...
| `python3.10` | `3.10.4-1.amzn2022.0.2` | 
...
| `scap-security-guide` | `0.1.58-1.amzn2022.0.1` | 
...
This release includes changes to the packages and package versions that are used in Amazon Linux 2022\.0\.20221101\. Some packages from Amazon Linux 2 aren't used in Amazon Linux 2022, some packages are new for Amazon Linux 2022, and some packages that were present in Amazon Linux 2 use new versions in Amazon Linux 2022\.
...
There are 1342 updated packages in Amazon Linux 2022\.
...
| `ant` | `1.9.2-9.amzn2.0.1` | `1.10.12-5.amzn2022.0.2` | 
...
| `bash` | `4.2.46-34.amzn2` | `5.1.8-2.amzn2022.0.1` | 
...
| `bluez` | `5.44-7.amzn2` | `5.62-2.amzn2022.0.1` | 
...
| `checkpolicy` | `2.5-6.amzn2` | `3.2-1.amzn2022.0.1` | 
| `checkpolicy` | `2.5-8.amzn2` | `3.2-1.amzn2022.0.1` | 
...
| `chrony` | `4.2-5.amzn2.0.2` | `4.2-7.amzn2022.0.3` | 
...
| `clamav` | `0.103.6-1.amzn2.0.1` | `0.103.7-1.amzn2022.0.2` | 
| `clang` | `11.1.0-1.amzn2.0.2` | `14.0.5-2.amzn2022.0.5` | 
| `cloud-init` | `19.3-46.amzn2` | `22.2.2-1.amzn2022.1.6` | 
...
| `containerd` | `1.6.6-1.amzn2.0.2` | `1.6.8-1.amzn2022.0.1` | 
| `containerd` | `1.6.6-1.amzn2.0.2` | `1.6.8-1.amzn2022.0.1` | 
| `containerd` | `1.6.6-1.amzn2.0.2` | `1.6.8-1.amzn2022.0.1` | 
...
| `curl` | `7.79.1-4.amzn2.0.1` | `7.85.0-1.amzn2022.0.1` | 
...
| `dbus` | `1.10.24-7.amzn2` | `1.12.20-3.amzn2022.0.1` | 
...
| `device-mapper-multipath` | `0.4.9-127.amzn2` | `0.8.7-9.amzn2022.0.2` | 
...
| `dnsmasq` | `2.76-16.amzn2.1.3` | `2.86-3.amzn2022.0.1` | 
| `dnsmasq` | `2.85-1.amzn2.0.1` | `2.86-3.amzn2022.0.1` | 
...
| `e2fsprogs` | `1.42.9-19.amzn2` | `1.45.6-5.amzn2022.0.1` | 
...
| `ecs-init` | `1.64.0-1.amzn2` | `1.63.1-1.amzn2022` | 
...
| `expat` | `2.1.0-14.amzn2.0.1` | `2.4.7-1.amzn2022.0.1` | 
...
| `freetype` | `2.8-14.amzn2.1` | `2.11.0-6.amzn2022.0.1` | 
...
| `ghostscript` | `9.25-5.amzn2` | `9.55.0-1.amzn2022.0.1` | 
| `giflib` | `4.1.6-9.amzn2.0.2` | `5.2.1-9.amzn2022` | 
| `git` | `2.37.1-1.amzn2.0.1` | `2.37.1-1.amzn2022.0.3` | 
...
| `glibc` | `2.26-61.amzn2` | `2.34-40.amzn2022.0.2` | 
...
| `gnutls` | `3.3.29-9.amzn2.0.1` | `3.7.2-2.amzn2022.0.2` | 
| `go-rpm-macros` | `3.0.15-23.amzn2.0.2` | `3.1.0-30.amzn2022` | 
| `gobject-introspection` | `1.56.1-1.amzn2` | `1.73.0-2.amzn2022.0.1` | 
| `golang` | `1.18.6-1.amzn2` | `1.19.1-1.amzn2022.0.2` | 
| `golang` | `1.11.13-2.amzn2.0.1` | `1.19.1-1.amzn2022.0.2` | 
| `golist` | `0.10.1-10.amzn2.0.1` | `0.10.1-11.amzn2022.0.1` | 
...
| `ImageMagick` | `6.9.10.68-5.amzn2.0.1` | `6.9.12.48-2.amzn2022.0.6` | 
...
| `iptables` | `1.8.4-10.amzn2.1.2` | `1.8.7-8.amzn2022.0.2` | 
...
| `kernel` | `4.14.294-220.533.amzn2` | `5.15.73-45.135.amzn2022` | 
| `kernel` | `5.10.130-118.517.amzn2` | `5.15.73-45.135.amzn2022` | 
| `kernel` | `5.4.217-126.408.amzn2` | `5.15.73-45.135.amzn2022` | 
| `kernel` | `5.10.147-133.644.amzn2` | `5.15.73-45.135.amzn2022` | 
| `kernel` | `5.15.73-48.135.amzn2` | `5.15.73-45.135.amzn2022` | 
...
| `libksba` | `1.3.0-5.amzn2.0.2` | `1.6.0-1.amzn2022.0.1` | 
| `libldb` | `1.5.4-2.amzn2` | `2.5.1-1.amzn2022.0.1` | 
...
| `libnftnl` | `1.1.5-4.amzn2` | `1.1.9-2.amzn2022.0.1` | 
...
| `libselinux` | `2.5-12.amzn2.0.2` | `3.2-1.amzn2022.0.2` | 
| `libselinux` | `2.5-15.amzn2.0.1` | `3.2-1.amzn2022.0.2` | 
| `libsemanage` | `2.5-11.amzn2` | `3.2-1.amzn2022.0.1` | 
| `libsemanage` | `2.5-14.amzn2` | `3.2-1.amzn2022.0.1` | 
| `libsepol` | `2.5-8.1.amzn2.0.2` | `3.3-2.amzn2022.0.1` | 
| `libsepol` | `2.5-10.amzn2` | `3.3-2.amzn2022.0.1` | 
...
| `libtiff` | `4.0.3-35.amzn2.0.2` | `4.4.0-1.amzn2022.0.1` | 
...
| `libxml2` | `2.9.1-6.amzn2.5.6` | `2.9.14-1.amzn2022.0.1` | 
...
| `mariadb` | `5.5.68-1.amzn2` | `10.5.16-1.amzn2022.0.4` | 
| `mariadb` | `10.5.10-2.amzn2.0.1` | `10.5.16-1.amzn2022.0.4` | 
...
| `mcstrans` | `0.3.4-5.amzn2.0.2` | `3.2-3.amzn2022.0.2` | 
...
| `microcode_ctl` | `2.1-47.amzn2.0.13` | `2.1-53.amzn2022` | 
...
| `ncurses` | `6.0-8.20170212.amzn2.1.3` | `6.2-4.20200222.amzn2022.0.1` | 
...
| `nftables` | `0.9.0-14.amzn2.0.1` | `0.9.8-3.amzn2022.0.2` | 
...
| `nss` | `3.67.0-4.amzn2.0.2` | `3.83.0-1.amzn2022.0.1` | 
...
| `openjpeg2` | `2.4.0-4.amzn2` | `2.4.0-11.amzn2022.0.2` | 
...
| `pcre2` | `10.23-2.amzn2.0.2` | `10.40-1.amzn2022.0.1` | 
...
| `policycoreutils` | `2.5-22.amzn2` | `3.2-1.amzn2022.0.2` | 
| `policycoreutils` | `2.5-34.amzn2` | `3.2-1.amzn2022.0.2` | 
| `polkit` | `0.112-26.amzn2.1` | `0.117-10.amzn2022.0.2` | 
| `polkit-pkla-compat` | `0.1-4.amzn2.0.2` | `0.1-19.amzn2022.0.1` | 
| `poppler` | `0.26.5-43.amzn2` | `21.01.0-7.amzn2022.0.2` | 
...
| `protobuf-c` | `1.0.2-3.amzn2.0.1` | `1.3.3-7.amzn2022.0.1` | 
...
| `python-bottle` | `0.12.21-2.amzn2` | `0.12.18-3.amzn2022.0.1` | 
...
| `python-pip` | `20.2.2-1.amzn2.0.3` | `21.3.1-2.amzn2022.0.3` | 
...
| `python3` | `3.7.10-1.amzn2.0.1` | `3.9.13-1.amzn2022.0.3` | 
...
| `rdma-core` | `35.0-1.amzn2.0.2` | `37.0-1.amzn2022.0.2` | 
...
| `rpm` | `4.11.3-48.amzn2.0.2` | `4.16.1.3-12.amzn2022.0.3` | 
| `rpm` | `4.14.3-4.amzn2.0.1` | `4.16.1.3-12.amzn2022.0.3` | 
...
| `rsync` | `3.1.2-4.amzn2` | `3.2.6-1.amzn2022.0.2` | 
...
| `scap-security-guide` | `0.1.40-12.amzn2.0.1.1` | `0.1.58-1.amzn2022.0.1` | 
...
| `selinux-policy` | `3.13.1-192.amzn2.6.8` | `34.21-1.amzn2022.0.2` | 
| `selinux-policy` | `3.13.1-268.amzn2.2.2` | `34.21-1.amzn2022.0.2` | 
| `sendmail` | `8.14.7-5.amzn2.0.1` | `8.17.1-5.amzn2022.0.3` | 
| `setools` | `3.3.8-2.amzn2.0.2` | `4.4.0-5.amzn2022.0.2` | 
| `setools` | `3.3.8-4.amzn2.0.1` | `4.4.0-5.amzn2022.0.2` | 
...
| `system-release` | `2-14.amzn2` | `2022.0.20221101-0.amzn2022` | 
| `systemd` | `219-78.amzn2.0.20` | `250.8-1.amzn2022.0.2` | 
...
| `tzdata` | `2022e-1.amzn2.0.1` | `2022e-1.amzn2022.0.1` | 
...
| `unzip` | `6.0-43.amzn2` | `6.0-50.amzn2022.0.1` | 
...
| `util-linux` | `2.30.2-2.amzn2.0.7` | `2.37.4-1.amzn2022.0.2` | 
...
| `vim` | `9.0.475-1.amzn2.0.1` | `9.0.475-1.amzn2022.0.1` | 
| `vim` | `8.0.1257-2.amzn2` | `9.0.475-1.amzn2022.0.1` | 
...
| `wireshark` | `1.10.14-24.amzn2` | `3.6.7-1.amzn2022.0.2` | 
...
| `xorg-x11-server` | `1.20.4-18.amzn2.0.1` | `1.20.14-3.amzn2022` | 
...
| `zlib` | `1.2.7-19.amzn2.0.2` | `1.2.11-32.amzn2022.0.3` | 
...
There are 1547 packages that were in Amazon Linux 2 that are not a part of Amazon Linux 2022\.
