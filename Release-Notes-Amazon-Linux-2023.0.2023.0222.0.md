...
## Repository<a name="amis-2023020230222.repository"></a>
...
## Minimal AMI<a name="amis-2023020230222.minimal-ami"></a>
...
|   `openssl-pkcs11`   |   `0.4.11-8.amzn2023.0.3`   | 
...
|   `perl-Text-Tabs+Wrap`   |   `2021.0726-1.amzn2023`   | 
...
|   `publicsuffix-list`   |   `20190417-5.amzn2023.0.2`   | 
...
|   `python-twisted`   |   `22.4.0-124.amzn2023.0.2`   | 
...
|   `python-werkzeug`   |   `1.0.1-5.amzn2023.0.2`   | 
...
|   `python3.9`   |   `3.9.16-1.amzn2023.0.2`   | 
...
|   `ruby3.2`   |   `3.2.0-177.amzn2023.0.1`   | 
...
|   `scap-security-guide`   |   `0.1.58-1.amzn2023.0.3`   | 
...
|   `wireshark`   |   `4.0.2-1.amzn2023.0.2`   | 
...
|   `xorg-x11-server`   |   `1.20.14-12.amzn2023.0.2`   | 
...
There are 1,345 updated packages in AL2023\.
...
|   `amazon-ecr-credential-helper`   |   `0.6.0-1.amzn2`   |   `0.6.0-1.amzn2023`   | 
|   `amazon-ecr-credential-helper`   |   `0.6.0-1.amzn2`   |   `0.6.0-1.amzn2023`   | 
|   `amazon-efs-utils`   |   `1.34.4-1.amzn2`   |   `1.34.5-1.amzn2023`   | 
...
|   `aws-nitro-enclaves-cli`   |   `1.2.1-0.amzn2`   |   `1.2.1-0.amzn2023`   | 
|   `awscli`   |   `1.18.147-1.amzn2.0.1`   |   `2.9.19-1.amzn2023.0.1`   | 
...
|   `binutils`   |   `2.29.1-31.amzn2`   |   `2.39-6.amzn2023.0.4`   | 
...
|   `ca-certificates`   |   `2021.2.50-72.amzn2.0.4`   |   `2021.2.50-1.0.amzn2023.0.6`   | 
...
|   `cifs-utils`   |   `6.2-10.amzn2.0.2`   |   `6.15-1.amzn2023.0.2`   | 
|   `cjkuni-uming-fonts`   |   `0.2.20080216.1-53.amzn2`   |   `0.2.20080216.1-66.amzn2023.0.2`   | 
|   `clamav`   |   `0.103.7-1.amzn2.0.1`   |   `0.103.8-1.amzn2023.0.1`   | 
|   `clang`   |   `11.1.0-1.amzn2.0.2`   |   `15.0.6-3.amzn2023.0.2`   | 
|   `cloud-init`   |   `19.3-46.amzn2`   |   `22.2.2-1.amzn2023.1.6`   | 
...
|   `cryptsetup`   |   `1.7.4-4.amzn2`   |   `2.4.3-2.amzn2023.0.2`   | 
...
|   `curl`   |   `7.87.0-2.amzn2.0.1`   |   `7.88.0-1.amzn2023.0.1`   | 
...
|   `device-mapper-multipath`   |   `0.4.9-136.amzn2`   |   `0.8.7-9.amzn2023.0.3`   | 
...
|   `dnf-plugins-core`   |   `4.0.2.2-3.amzn2`   |   `4.1.0-1.amzn2023.0.2`   | 
...
|   `ec2-hibinit-agent`   |   `1.0.2-3.amzn2`   |   `1.0.4-0.amzn2023.0.2`   | 
...
|   `ecs-init`   |   `1.68.2-1.amzn2`   |   `1.68.2-1.amzn2023`   | 
...
|   `emacs`   |   `27.2-4.amzn2.0.2`   |   `28.1-2.amzn2023.0.2`   | 
...
|   `firewalld`   |   `0.4.4.4-6.amzn2.0.1`   |   `1.0.4-1.amzn2023.0.3`   | 
...
|   `ghostscript`   |   `9.25-5.amzn2`   |   `9.56.1-5.amzn2023.0.1`   | 
|   `giflib`   |   `4.1.6-9.amzn2.0.2`   |   `5.2.1-9.amzn2023`   | 
|   `git`   |   `2.39.1-1.amzn2.0.1`   |   `2.39.2-1.amzn2023.0.1`   | 
...
|   `gnutls`   |   `3.3.29-9.amzn2.0.1`   |   `3.7.7-357.amzn2023.0.2`   | 
...
|   `grub2`   |   `2.06-9.amzn2.0.1`   |   `2.06-61.amzn2023.0.3`   | 
...
|   `ImageMagick`   |   `6.9.10.68-5.amzn2.0.1`   |   `6.9.12.64-1.amzn2023.0.2`   | 
...
|   `kernel`   |   `4.14.304-226.531.amzn2`   |   `6.1.12-19.43.amzn2023`   | 
|   `kernel`   |   `5.10.130-118.517.amzn2`   |   `6.1.12-19.43.amzn2023`   | 
|   `kernel`   |   `5.4.231-137.341.amzn2`   |   `6.1.12-19.43.amzn2023`   | 
|   `kernel`   |   `5.10.167-147.601.amzn2`   |   `6.1.12-19.43.amzn2023`   | 
|   `kernel`   |   `5.15.93-55.139.amzn2`   |   `6.1.12-19.43.amzn2023`   | 
...
|   `kpatch`   |   `0.9.4-6.amzn2`   |   `0.9.4-7.amzn2023.0.3`   | 
|   `krb5`   |   `1.15.1-55.amzn2.2.5`   |   `1.19.2-13.amzn2023.0.2`   | 
...
|   `less`   |   `458-9.amzn2.0.2`   |   `590-2.amzn2023.0.2`   | 
...
|   `libdb`   |   `5.3.21-24.amzn2.0.3`   |   `5.3.28-49.amzn2023.0.2`   | 
...
|   `libqb`   |   `1.0.5-1.amzn2`   |   `2.0.3-1.amzn2023.0.2`   | 
...
|   `libsigc++20`   |   `2.10.0-1.amzn2.0.2`   |   `2.10.7-1.amzn2023.0.2`   | 
...
|   `libXpm`   |   `3.5.12-1.amzn2.0.2`   |   `3.5.15-2.amzn2023.0.1`   | 
...
|   `lynis`   |   `3.0.0-1.amzn2.0.2`   |   `3.0.6-1.amzn2023.0.4`   | 
...
|   `mariadb`   |   `10.5.10-2.amzn2.0.2`   |   `10.5.16-1.amzn2023.0.7`   | 
...
|   `mod_http2`   |   `1.15.19-1.amzn2.0.1`   |   `1.15.24-1.amzn2023.0.3`   | 
|   `modello`   |   `1.7-4.amzn2`   |   `1.11-8.amzn2023.0.3`   | 
|   `mojo-parent`   |   `32-4.amzn2`   |   `60-5.amzn2023.0.3`   | 
|   `mokutil`   |   `0.3.0-10.amzn2.0.1`   |   `0.5.0-1.amzn2023.0.3`   | 
...
|   `nghttp2`   |   `1.41.0-1.amzn2`   |   `1.45.1-1.amzn2023.0.3`   | 
...
|   `nss`   |   `3.79.0-4.amzn2`   |   `3.83.0-1.amzn2023.0.2`   | 
...
|   `openssl-pkcs11`   |   `0.4.10-3.amzn2.0.1`   |   `0.4.11-8.amzn2023.0.3`   | 
...
|   `pesign`   |   `0.109-10.amzn2.0.1`   |   `115-1.amzn2023.0.4`   | 
...
|   `postgresql`   |   `9.2.24-8.amzn2`   |   `15.0-1.amzn2023.0.2`   | 
...
|   `procmail`   |   `3.22-36.amzn2.1.2`   |   `3.22-54.amzn2023.0.2`   | 
|   `procps-ng`   |   `3.3.10-26.amzn2`   |   `3.3.17-1.amzn2023.0.2`   | 
|   `protobuf`   |   `2.5.0-8.amzn2.0.2`   |   `3.19.6-1.amzn2023.0.1`   | 
...
|   `python-lxml`   |   `3.2.1-4.amzn2.0.3`   |   `4.7.1-3.amzn2023.0.1`   | 
...
|   `python3`   |   `3.7.16-1.amzn2.0.1`   |   `3.9.16-1.amzn2023.0.2`   | 
...
|   `rsyslog`   |   `8.24.0-57.amzn2.2.0.1`   |   `8.2204.0-3.amzn2023.0.2`   | 
|   `rtkit`   |   `0.11-10.amzn2.0.1`   |   `0.11-26.amzn2023.0.2`   | 
|   `runc`   |   `1.1.4-1.amzn2.0.1`   |   `1.1.3-1.amzn2023.0.2`   | 
|   `runc`   |   `1.1.4-1.amzn2.0.1`   |   `1.1.3-1.amzn2023.0.2`   | 
|   `runc`   |   `1.1.4-1.amzn2.0.1`   |   `1.1.3-1.amzn2023.0.2`   | 
|   `rust`   |   `1.61.0-2.amzn2.0.1`   |   `1.66.1-1.amzn2023.0.3`   | 
...
|   `scap-security-guide`   |   `0.1.40-12.amzn2.0.1.1`   |   `0.1.58-1.amzn2023.0.3`   | 
...
|   `snakeyaml`   |   `1.11-8.amzn2`   |   `1.27-6.amzn2023.0.1`   | 
...
|   `sscg`   |   `2.3.3-2.amzn2.0.1`   |   `3.0.1-61.amzn2023.0.2`   | 
...
|   `sudo`   |   `1.8.23-10.amzn2.1`   |   `1.9.12-1.p2.amzn2023.0.2`   | 
...
|   `system-release`   |   `2-14.amzn2`   |   `2023.0.20230222-0.amzn2023`   | 
|   `systemd`   |   `219-78.amzn2.0.21`   |   `252.4-1161.amzn2023.0.1`   | 
...
|   `tpm2-tss`   |   `1.3.0-2.amzn2`   |   `3.1.0-1.amzn2023.0.3`   | 
...
|   `tzdata`   |   `2022f-1.amzn2.0.1`   |   `2022g-1.amzn2023.0.1`   | 
...
|   `update-motd`   |   `1.1.2-2.amzn2.0.2`   |   `2.0-1.amzn2023.0.2`   | 
...
|   `vim`   |   `9.0.1160-1.amzn2.0.1`   |   `9.0.1160-1.amzn2023.0.2`   | 
|   `vim`   |   `8.0.1257-2.amzn2`   |   `9.0.1160-1.amzn2023.0.2`   | 
...
|   `wireshark`   |   `1.10.14-24.amzn2`   |   `4.0.2-1.amzn2023.0.2`   | 
...
|   `xorg-x11-server`   |   `1.20.4-19.amzn2.0.1`   |   `1.20.14-12.amzn2023.0.2`   | 
...
There are 874 packages new for AL2023\.
...
There are 1,547 packages that were in Amazon Linux 2 that aren't a part of AL2023\.
