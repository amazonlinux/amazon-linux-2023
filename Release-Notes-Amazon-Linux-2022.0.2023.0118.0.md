...
## Major updates<a name="major-updates-20230118"></a>
...
## Default AMI<a name="amis-2022020230118.default-ami"></a>
...
|   `mariadb105`   |   `10.5.16-1.amzn2022.0.6`   | 
...
|   `patchelf`   |   `0.17.0-1.amzn2022.0.1`   | 
...
|   `perl-DBD-Pg`   |   `3.14.2-3.amzn2022.0.3`   | 
...
|   `postfix`   |   `3.7.2-4.amzn2022.0.3`   | 
|   `postgresql15`   |   `15.0-1.amzn2022.0.1`   | 
...
|   `python-lit`   |   `15.0.6-1.amzn2022`   | 
|   `python-lockfile`   |   `0.12.2-5.amzn2022.0.1`   | 
|   `python-lxml`   |   `4.7.1-3.amzn2022`   | 
...
|   `python-psycopg2`   |   `2.8.6-3.amzn2022.0.2`   | 
...
|   `python3.10`   |   `3.10.9-1.amzn2022.0.1`   | 
|   `python3.9`   |   `3.9.16-1.amzn2022.0.1`   | 
...
|   `sphinx`   |   `2.2.11-24.amzn2022.0.2`   | 
|   `spirv-headers`   |   `1.5.5-41.amzn2022`   | 
|   `spirv-llvm-translator`   |   `15.0.0-2.amzn2022.0.1`   | 
|   `spirv-tools`   |   `2022.2-2.amzn2022.0.1`   | 
|   `sqlite`   |   `3.40.0-1.amzn2022.0.1`   | 
...
|   `texlive`   |   `2021-59.amzn2022.0.1`   | 
|   `texlive-base`   |   `20210325-52.amzn2022.0.1`   | 
...
|   `wireshark`   |   `4.0.2-1.amzn2022.0.1`   | 
...
This release includes changes to the packages and package versions that are used in Amazon Linux xxxx\.x\.xxxxxxxx\. Some packages from Amazon Linux 2 aren't used in Amazon Linux 2022, some packages are new for Amazon Linux 2022, and some packages that were present in Amazon Linux 2 use new versions in Amazon Linux 2022\.

### Amazon Linux 2022 packages<a name="version-compare-al2023"></a>
...
There are 1,340 updated packages in Amazon Linux 2022\.
...
|   `amazon-ecr-credential-helper`   |   `0.6.0-1.amzn2`   |   `0.6.0-1.amzn2022`   | 
|   `amazon-ecr-credential-helper`   |   `0.6.0-1.amzn2`   |   `0.6.0-1.amzn2022`   | 
|   `amazon-efs-utils`   |   `1.34.4-1.amzn2`   |   `1.34.4-1.amzn2022`   | 
...
|   `apr`   |   `1.7.0-9.amzn2`   |   `1.7.0-16.amzn2022.0.1`   | 
|   `apr-util`   |   `1.6.1-5.amzn2.0.2`   |   `1.6.1-16.amzn2022.0.2`   | 
...
|   `bash`   |   `4.2.46-34.amzn2`   |   `5.2.15-1.amzn2022.0.1`   | 
...
|   `ca-certificates`   |   `2021.2.50-72.amzn2.0.4`   |   `2021.2.50-1.0.amzn2022.0.4`   | 
...
|   `chrony`   |   `4.2-5.amzn2.0.2`   |   `4.3-1.amzn2022.0.1`   | 
...
|   `clang`   |   `11.1.0-1.amzn2.0.2`   |   `15.0.6-3.amzn2022.0.1`   | 
...
|   `containerd`   |   `1.6.8-1.amzn2.0.1`   |   `1.6.8-2.amzn2022.0.1`   | 
|   `containerd`   |   `1.6.8-1.amzn2.0.1`   |   `1.6.8-2.amzn2022.0.1`   | 
|   `containerd`   |   `1.6.8-1.amzn2.0.1`   |   `1.6.8-2.amzn2022.0.1`   | 
...
|   `cpio`   |   `2.11-28.amzn2`   |   `2.13-13.amzn2022.0.1`   | 
...
|   `docker`   |   `20.10.17-1.amzn2.0.2`   |   `20.10.17-1.amzn2022.0.3`   | 
|   `docker`   |   `20.10.17-1.amzn2.0.2`   |   `20.10.17-1.amzn2022.0.3`   | 
|   `docker`   |   `20.10.17-1.amzn2.0.2`   |   `20.10.17-1.amzn2022.0.3`   | 
...
|   `ecs-init`   |   `1.68.0-1.amzn2`   |   `1.68.0-1.amzn2022`   | 
...
|   `elfutils`   |   `0.176-2.amzn2`   |   `0.188-3.amzn2022.0.1`   | 
|   `elinks`   |   `0.12-0.57.pre6.amzn2.0.2`   |   `0.12-0.65.pre6.amzn2022.0.1`   | 
|   `emacs`   |   `27.2-4.amzn2.0.1`   |   `28.1-2.amzn2022.0.1`   | 
...
|   `freetype`   |   `2.8-14.amzn2.1.1`   |   `2.12.1-3.amzn2022`   | 
...
|   `gcc`   |   `7.3.1-15.amzn2`   |   `11.3.1-4.amzn2022.0.1`   | 
...
|   `golist`   |   `0.10.1-10.amzn2.0.2`   |   `0.10.1-11.amzn2022.0.2`   | 
...
|   `grub2`   |   `2.06-9.amzn2.0.1`   |   `2.06-42.amzn2022.0.2`   | 
...
|   `java-1.8.0-amazon-corretto`   |   `1.8.0_362.b08-1.amzn2`   |   `1.8.0_362.b08-1.amzn2022`   | 
|   `java-11-amazon-corretto`   |   `11.0.18+10-1.amzn2`   |   `11.0.18+10-1.amzn2022`   | 
|   `java-17-amazon-corretto`   |   `17.0.6+10-1.amzn2.1`   |   `17.0.6+10-1.amzn2022.1`   | 
...
|   `kernel`   |   `4.14.301-224.520.amzn2`   |   `5.15.73-45.135.amzn2022`   | 
|   `kernel`   |   `5.10.130-118.517.amzn2`   |   `5.15.73-45.135.amzn2022`   | 
|   `kernel`   |   `5.4.228-131.415.amzn2`   |   `5.15.73-45.135.amzn2022`   | 
|   `kernel`   |   `5.10.162-141.675.amzn2`   |   `5.15.73-45.135.amzn2022`   | 
|   `kernel`   |   `5.15.86-53.137.amzn2`   |   `5.15.73-45.135.amzn2022`   | 
...
|   `krb5`   |   `1.15.1-55.amzn2.2.5`   |   `1.19.2-13.amzn2022.0.1`   | 
...
|   `libdwarf`   |   `20130207-4.amzn2.0.2`   |   `0.5.0-1.amzn2022.0.1`   | 
...
|   `libpng`   |   `1.5.13-8.amzn2.0.1`   |   `1.6.37-10.amzn2022.0.1`   | 
|   `libpq`   |   `11.5-1.amzn2`   |   `15.0-2.amzn2022`   | 
|   `libpq`   |   `12.11-1.amzn2.0.1`   |   `15.0-2.amzn2022`   | 
|   `libpq`   |   `13.3-1.amzn2`   |   `15.0-2.amzn2022`   | 
|   `libpq`   |   `14.3-2.amzn2.0.2`   |   `15.0-2.amzn2022`   | 
...
|   `libtasn1`   |   `4.10-1.amzn2.0.3`   |   `4.19.0-1.amzn2022`   | 
...
|   `llvm`   |   `11.1.0-1.amzn2.0.2`   |   `15.0.6-2.amzn2022.0.1`   | 
...
|   `mariadb`   |   `5.5.68-1.amzn2`   |   `10.5.16-1.amzn2022.0.6`   | 
|   `mariadb`   |   `10.5.10-2.amzn2.0.2`   |   `10.5.16-1.amzn2022.0.6`   | 
...
|   `nginx`   |   `1.22.1-1.amzn2.0.2`   |   `1.22.1-1.amzn2022.0.1`   | 
...
|   `patchelf`   |   `0.17.0-1.amzn2.0.1`   |   `0.17.0-1.amzn2022.0.1`   | 
...
|   `perl-DBD-Pg`   |   `2.19.3-4.amzn2.0.2`   |   `3.14.2-3.amzn2022.0.3`   | 
...
|   `postfix`   |   `2.10.1-6.amzn2.0.3`   |   `3.7.2-4.amzn2022.0.3`   | 
...
|   `python-chevron`   |   `0.13.1-1.amzn2.0.2`   |   `0.13.1-1.amzn2022.0.2`   | 
|   `python-colorama`   |   `0.3.9-3.amzn2.0.1`   |   `0.4.4-2.amzn2022.0.1`   | 
...
|   `python-dateutil`   |   `2.6.1-3.amzn2`   |   `2.8.1-3.amzn2022.0.1`   | 
...
|   `python-jmespath`   |   `0.9.3-1.amzn2.0.2`   |   `0.10.0-1.amzn2022.0.1`   | 
|   `python-jsonpatch`   |   `1.2-4.amzn2`   |   `1.21-14.amzn2022.0.1`   | 
|   `python-jsonpointer`   |   `1.9-2.amzn2`   |   `2.0-2.amzn2022.0.1`   | 
|   `python-jsonschema`   |   `2.5.1-3.amzn2.0.2`   |   `3.2.0-9.amzn2022.0.2`   | 
|   `python-kmod`   |   `0.9-4.amzn2.0.2`   |   `0.9-30.amzn2022.0.1`   | 
|   `python-lit`   |   `0.11.1-1.amzn2.0.1`   |   `15.0.6-1.amzn2022`   | 
|   `python-lockfile`   |   `0.11.0-17.amzn2.0.2`   |   `0.12.2-5.amzn2022.0.1`   | 
|   `python-lxml`   |   `3.2.1-4.amzn2.0.3`   |   `4.7.1-3.amzn2022`   | 
...
|   `python-psycopg2`   |   `2.5.1-3.amzn2.0.2`   |   `2.8.6-3.amzn2022.0.2`   | 
|   `python-py`   |   `1.4.32-1.amzn2`   |   `1.10.0-2.amzn2022.0.1`   | 
|   `python-pyasn1`   |   `0.1.9-7.amzn2.0.2`   |   `0.4.8-4.amzn2022.0.1`   | 
...
|   `python-rsa`   |   `3.4.1-1.amzn2.0.3`   |   `4.7.2-1.amzn2022.0.1`   | 
...
|   `python-six`   |   `1.11.0-8.amzn2.0.1`   |   `1.15.0-5.amzn2022.0.1`   | 
...
|   `python3`   |   `3.7.16-1.amzn2.0.1`   |   `3.9.16-1.amzn2022.0.1`   | 
...
|   `runc`   |   `1.1.4-1.amzn2.0.1`   |   `1.1.3-1.amzn2022.0.1`   | 
|   `runc`   |   `1.1.4-1.amzn2.0.1`   |   `1.1.3-1.amzn2022.0.1`   | 
|   `runc`   |   `1.1.4-1.amzn2.0.1`   |   `1.1.3-1.amzn2022.0.1`   | 
|   `rust`   |   `1.61.0-2.amzn2.0.1`   |   `1.66.1-1.amzn2022.0.2`   | 
|   `rust`   |   `1.47.0-1.amzn2.0.1`   |   `1.66.1-1.amzn2022.0.2`   | 
|   `samba`   |   `4.10.16-20.amzn2.0.1`   |   `4.16.7-0.amzn2022.0.1`   | 
...
|   `sphinx`   |   `2.2.11-5.amzn2.0.1`   |   `2.2.11-24.amzn2022.0.2`   | 
|   `sqlite`   |   `3.7.17-8.amzn2.1.2`   |   `3.40.0-1.amzn2022.0.1`   | 
...
|   `system-release`   |   `2-14.amzn2`   |   `2022.0.20230118-0.amzn2022`   | 
...
|   `texlive`   |   `2012-38.20130427_r30134.amzn2.0.5`   |   `2021-59.amzn2022.0.1`   | 
...
|   `vim`   |   `9.0.1006-1.amzn2.0.1`   |   `9.0.1006-1.amzn2022.0.1`   | 
|   `vim`   |   `8.0.1257-2.amzn2`   |   `9.0.1006-1.amzn2022.0.1`   | 
...
|   `wireshark`   |   `1.10.14-24.amzn2`   |   `4.0.2-1.amzn2022.0.1`   | 
...
|   `xorg-x11-server`   |   `1.20.4-19.amzn2.0.1`   |   `1.20.14-9.amzn2022.0.1`   | 
...
There are 890 packages new for Amazon Linux 2022\.
...
There are 1,544 packages that were in Amazon Linux 2 that aren't a part of Amazon Linux 2022\.
