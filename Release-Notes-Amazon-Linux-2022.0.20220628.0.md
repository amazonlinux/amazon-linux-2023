...
Amazon Linux 2022 was updated in preview June 28, 2022\.
...
|  `aws-c-mqtt-libs-0.7.8-7.amzn2022`  | 
...
|  `dracut-config-rescue-055-6.amzn2022.0.3`  | 
...
|  `gpgme-devel-1.15.1-6.amzn2022.0.1`  | 
...
|  `libinput-utils-1.19.4-1.amzn2022`  | 
...
|  `libvirt-lock-sanlock-8.1.0-2.amzn2022.0.2`  | 
...
|  `pcp-export-pcp2influxdb-5.3.5-1.amzn2022.1.1`  | 
...
|  `pcp-pmda-infiniband-5.3.5-1.amzn2022.1.1`  | 
...
|  `pcp-pmda-slurm-5.3.5-1.amzn2022.1.1`  | 
...
|  `php-embedded-8.1.7-1.amzn2022.0.4`  | 
...
|  `protobuf-lite-3.14.0-7.amzn2022.0.1`  | 
...
|  `python3-solv-0.7.22-1.amzn2022`  | 
...
|  `qemu-ui-curses-6.2.0-9.amzn2022.0.3`  | 
...
|  `rsyslog-openssl-8.2204.0-1.amzn2022.0.3`  | 
...
|  `systemtap-runtime-python3-4.7-1.amzn2022.0.1`  | 
...
|  `rpm-build-libs-4.16.1.3-12.amzn2022.aarch64 `  | 
...
| `python-awscrt` | `0.12.6-3.amzn2022.0.1` | 
...
| `python-pip` | `21.0.1-4.amzn2022.0.1` | 
...
| `python-psutil` | `5.8.0-5.amzn2022.0.2` | 
...
| `sgabios` | `0.20180715git-8.amzn2022.0.1` | 
...
There are 1393 updated packages in Amazon Linux 2022\.
...
|   `amazon-cloudwatch-agent`   |   `1.247350.0-1.amzn2`   |   `1.247353.0_4_g9be43599-1.amzn2022`   | 
|   `amazon-efs-utils`   |   `1.33.1-1.amzn2`   |   `1.32.1-1.amzn2022`   | 
...
|   `automake`   |   `1.13.4-3.1.amzn2`   |   `1.16.2-4.amzn2022.0.1`   | 
|   `autotrace`   |   `0.31.1-38.amzn2`   |   `0.31.1-62.amzn2022`   | 
|   `avahi`   |   `0.6.31-20.amzn2`   |   `0.8-14.amzn2022.0.4`   | 
|   `aws-kinesis-agent`   |   `2.0.6-1.amzn2`   |   `2.0.7-1.amzn2022`   | 
|   `awscli`   |   `1.18.147-1.amzn2.0.1`   |   `2.7.8-1.amzn2022.0.1`   | 
...
|   `cmake`   |   `2.8.12.2-2.amzn2.0.2`   |   `3.20.5-1.amzn2022.0.1`   | 
...
|   `containerd`   |   `1.4.13-3.amzn2`   |   `1.6.6-1.amzn2022`   | 
|   `containerd`   |   `1.4.13-3.amzn2`   |   `1.6.6-1.amzn2022`   | 
|   `containerd`   |   `1.4.13-3.amzn2`   |   `1.6.6-1.amzn2022`   | 
...
|   `curl`   |   `7.79.1-2.amzn2.0.1`   |   `7.83.1-1.amzn2022`   | 
...
|   `docker`   |   `20.10.13-2.amzn2`   |   `20.10.17-1.amzn2022`   | 
|   `docker`   |   `20.10.13-2.amzn2`   |   `20.10.17-1.amzn2022`   | 
|   `docker`   |   `20.10.13-2.amzn2`   |   `20.10.17-1.amzn2022`   | 
...
|   `ecs-init`   |   `1.61.1-1.amzn2`   |   `1.61.3-1.amzn2022`   | 
|   `ed`   |   `1.9-4.amzn2.0.2`   |   `1.14.2-10.amzn2022`   | 
|   `edk2`   |   `20200801stable-1.amzn2.0.1`   |   `20220221gitb24306f15daa-4.amzn2022.0.1`   | 
...
|   `gcc`   |   `7.3.1-15.amzn2`   |   `11.3.1-2.amzn2022.0.2`   | 
...
|   `geoclue2`   |   `2.4.5-1.amzn2.0.2`   |   `2.5.7-6.amzn2022.0.1`   | 
...
|   `git`   |   `2.32.0-1.amzn2.0.1`   |   `2.36.1-1.amzn2022.0.3`   | 
...
|   `glibc`   |   `2.26-58.amzn2`   |   `2.34-32.amzn2022.0.1`   | 
...
|   `golang`   |   `1.16.15-1.amzn2.0.1`   |   `1.18.3-1.amzn2022`   | 
|   `golang`   |   `1.11.13-2.amzn2.0.1`   |   `1.18.3-1.amzn2022`   | 
...
|   `GraphicsMagick`   |   `1.3.34-1.amzn2`   |   `1.3.36-3.amzn2022`   | 
|   `graphite2`   |   `1.3.10-1.amzn2.0.2`   |   `1.3.14-7.amzn2022`   | 
|   `graphviz`   |   `2.30.1-21.amzn2.0.1`   |   `2.44.0-25.amzn2022.0.2`   | 
...
|   `hiredis`   |   `0.13.3-15.amzn2`   |   `0.13.3-15.amzn2022`   | 
...
|   `ibus`   |   `1.5.17-11.amzn2`   |   `1.5.24-5.amzn2022.0.1`   | 
...
|   `ImageMagick`   |   `6.9.10.68-5.amzn2.0.1`   |   `6.9.12.48-2.amzn2022.0.3`   | 
...
|   `iproute`   |   `5.10.0-2.amzn2.0.2`   |   `5.10.0-2.amzn2022`   | 
|   `iproute`   |   `5.10.0-2.amzn2.0.2`   |   `5.10.0-2.amzn2022`   | 
...
|   `ipxe`   |   `20190125-1.git36a4c85f.amzn2`   |   `20200823-8.git4bd064de.amzn2022.0.1`   | 
...
|   `java-11-openjdk`   |   `11.0.13.0.8-1.amzn2.0.3`   |   `11.0.14.1.1-5.amzn2022`   | 
...
|   `kernel`   |   `4.14.281-212.502.amzn2`   |   `5.15.43-20.123.amzn2022`   | 
|   `kernel`   |   `5.10.106-102.504.amzn2`   |   `5.15.43-20.123.amzn2022`   | 
|   `kernel`   |   `5.4.196-108.356.amzn2`   |   `5.15.43-20.123.amzn2022`   | 
|   `kernel`   |   `5.10.118-111.515.amzn2`   |   `5.15.43-20.123.amzn2022`   | 
|   `kernel`   |   `5.15.43-20.123.amzn2`   |   `5.15.43-20.123.amzn2022`   | 
...
|   `libgdiplus`   |   `5.6-3.amzn2`   |   `6.0.4-5.amzn2022`   | 
...
|   `libldb`   |   `1.5.4-2.amzn2`   |   `2.4.2-1.amzn2022`   | 
...
|   `libsass`   |   `3.6.1-1.amzn2`   |   `3.6.4-3.amzn2022`   | 
...
|   `libsrtp`   |   `1.4.4-11.20101004cvs.amzn2`   |   `2.3.0-6.amzn2022`   | 
...
|   `libvirt`   |   `4.5.0-36.amzn2.3`   |   `8.1.0-2.amzn2022.0.2`   | 
|   `libvirt-python`   |   `3.9.0-1.amzn2`   |   `8.1.0-1.amzn2022`   | 
...
|   `libxml2`   |   `2.9.1-6.amzn2.5.4`   |   `2.9.14-1.amzn2022`   | 
...
|   `mc`   |   `4.8.7-11.amzn2.0.2`   |   `4.8.28-2.amzn2022`   | 
...
|   `nginx`   |   `1.20.0-2.amzn2.0.4`   |   `1.20.1-8.amzn2022.0.2`   | 
...
|   `openssh`   |   `7.4p1-22.amzn2.0.1`   |   `8.6p1-5.amzn2022.0.2`   | 
|   `openssl`   |   `1.0.2k-24.amzn2.0.3`   |   `3.0.3-1.amzn2022.0.1`   | 
...
|   `pcp`   |   `4.3.2-12.amzn2.0.1`   |   `5.3.5-1.amzn2022.1.1`   | 
...
|   `php`   |   `5.4.16-46.amzn2.0.2`   |   `8.1.7-1.amzn2022.0.4`   | 
|   `php`   |   `7.4.29-1.amzn2`   |   `8.1.7-1.amzn2022.0.4`   | 
|   `php`   |   `8.0.18-1.amzn2`   |   `8.1.7-1.amzn2022.0.4`   | 
...
|   `policycoreutils`   |   `2.5-34.amzn2`   |   `3.2-1.amzn2022`   | 
|   `polkit`   |   `0.112-26.amzn2.1`   |   `0.117-10.amzn2022`   | 
...
|   `postgresql`   |   `9.2.24-6.amzn2`   |   `13.5-1.amzn2022.0.1`   | 
|   `postgresql`   |   `9.6.22-1.amzn2.0.1`   |   `13.5-1.amzn2022.0.1`   | 
|   `postgresql`   |   `10.17-1.amzn2.0.2`   |   `13.5-1.amzn2022.0.1`   | 
|   `postgresql`   |   `11.12-1.amzn2.0.1`   |   `13.5-1.amzn2022.0.1`   | 
|   `postgresql`   |   `12.7-1.amzn2.0.1`   |   `13.5-1.amzn2022.0.1`   | 
|   `postgresql`   |   `13.3-2.amzn2.0.1`   |   `13.5-1.amzn2022.0.1`   | 
|   `postgresql`   |   `14.1-3.amzn2.0.1`   |   `13.5-1.amzn2022.0.1`   | 
...
|   `pystache`   |   `0.5.3-2.amzn2`   |   `0.5.4-12.amzn2022.0.2`   | 
...
|   `python-coverage`   |   `5.5-1.amzn2.0.1`   |   `5.5-1.amzn2022`   | 
...
|   `python-pip`   |   `20.2.2-1.amzn2.0.3`   |   `21.0.1-4.amzn2022.0.1`   | 
|   `python-ply`   |   `3.4-11.amzn2`   |   `3.11-11.amzn2022`   | 
|   `python-prettytable`   |   `0.7.2-3.amzn2`   |   `0.7.2-25.amzn2022`   | 
|   `python-psutil`   |   `5.6.7-1.amzn2.0.2`   |   `5.8.0-5.amzn2022.0.2`   | 
...
|   `python3`   |   `3.7.10-1.amzn2.0.1`   |   `3.9.13-1.amzn2022`   | 
...
|   `qemu`   |   `3.1.0-8.amzn2.0.8`   |   `6.2.0-9.amzn2022.0.3`   | 
...
|   `rpm`   |   `4.11.3-48.amzn2.0.2`   |   `4.16.1.3-12.amzn2022`   | 
|   `rpm`   |   `4.14.3-4.amzn2.0.1`   |   `4.16.1.3-12.amzn2022`   | 
...
|   `ruby`   |   `2.6.10-129.amzn2.0.1`   |   `3.0.2-149.amzn2022`   | 
|   `ruby`   |   `3.0.4-155.amzn2.0.1`   |   `3.0.2-149.amzn2022`   | 
|   `runc`   |   `1.0.3-3.amzn2`   |   `1.1.3-1.amzn2022`   | 
|   `runc`   |   `1.0.3-3.amzn2`   |   `1.1.3-1.amzn2022`   | 
|   `runc`   |   `1.0.3-3.amzn2`   |   `1.1.3-1.amzn2022`   | 
|   `rust`   |   `1.47.0-1.amzn2.0.1`   |   `1.58.1-1.amzn2022.0.1`   | 
|   `samba`   |   `4.10.16-18.amzn2.0.1`   |   `4.15.7-0.amzn2022.0.1`   | 
...
|   `seabios`   |   `1.11.0-2.amzn2`   |   `1.16.0-1.amzn2022.0.1`   | 
|   `sed`   |   `4.2.2-5.amzn2.0.2`   |   `4.8-7.amzn2022`   | 
|   `selinux-policy`   |   `3.13.1-192.amzn2.6.8`   |   `34.21-1.amzn2022`   | 
|   `selinux-policy`   |   `3.13.1-268.amzn2.2.2`   |   `34.21-1.amzn2022`   | 
...
|   `sgabios`   |   `0.20110622svn-4.amzn2.0.1`   |   `0.20180715git-8.amzn2022.0.1`   | 
...
|   `subversion`   |   `1.7.14-16.amzn2.0.1`   |   `1.14.2-1.amzn2022.0.2`   | 
...
|   `syslinux`   |   `4.05-13.amzn2.0.1`   |   `6.04-0.17.amzn2022.0.1`   | 
|   `sysstat`   |   `10.1.5-18.amzn2.0.1`   |   `12.5.4-1.amzn2022`   | 
|   `system-release`   |   `2-14.amzn2`   |   `2022.0.20220628-0.amzn2022`   | 
|   `systemd`   |   `219-78.amzn2.0.18`   |   `250.7-1.amzn2022.0.2`   | 
|   `systemtap`   |   `4.4-1.amzn2.0.2`   |   `4.7-1.amzn2022.0.1`   | 
...
|   `texlive`   |   `2012-38.20130427_r30134.amzn2.0.5`   |   `2020-38.amzn2022.0.2`   | 
...
|   `tomcat`   |   `8.5.75-1.amzn2.0.1`   |   `9.0.59-1.amzn2022`   | 
|   `tomcat`   |   `9.0.58-1.amzn2.0.1`   |   `9.0.59-1.amzn2022`   | 
...
|   `util-linux`   |   `2.30.2-2.amzn2.0.7`   |   `2.37.4-1.amzn2022`   | 
...
|   `vim`   |   `8.2.4857-1.amzn2.0.1`   |   `8.2.4975-1.amzn2022.0.2`   | 
|   `vim`   |   `8.0.1257-2.amzn2`   |   `8.2.4975-1.amzn2022.0.2`   | 
...
There are 984 packages new for Amazon Linux 2022\.
...
There are 1489 packages that were in Amazon Linux 2 that are not a part of Amazon Linux 2022\.
