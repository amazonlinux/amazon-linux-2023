...
+ [Amazon Linux 2022 release notes](#relnotes)
   ...
   + [Amazon Linux 2022 release notes update 2022-04-19](#relnotes-20220419)
+ [Amazon Linux 2022 packages](#all-packages)
   + [Amazon Linux 2022 packages updated 2022-04-19](#all-packages-al2022-20220419)
...
**Topics**
+ [Planned changes](#planned-changes)
+ [Amazon Linux 2022 release notes update 2022\-03\-015](#relnotes-20220419)
...
| CVEs fixed | 
| --- | 
|  [CVE\-2022\-25636](https://alas.aws.amazon.com/cve/html/CVE-2022-25636.html) \[`netfilter: nf_tables_offload`: incorrect flow offload action array size\]  | 
|  [CVE\-2022\-26966](https://alas.aws.amazon.com/cve/html/CVE-2022-26966.html) \[`sr9700`: sanity check for packet length\]  | 
|  [CVE\-2022\-0001](https://alas.aws.amazon.com/cve/html/CVE-2022-0001.html) \[`x86/speculation`: Rename `RETPOLINE_AMD` to `RETPOLINE_LFENCE`\]  | 
|  [CVE\-2022\-0002](https://alas.aws.amazon.com/cve/html/CVE-2022-0002.html) \[`x86/speculation`: Rename `RETPOLINE_AMD` to `RETPOLINE_LFENCE`\]  | 
|  [CVE\-2022\-23036](https://alas.aws.amazon.com/cve/html/CVE-2022-23036.html) \[`xen/grant-table`: add `gnttab_try_end_foreign_access()`\]  | 
|  [CVE\-2022\-23037](https://alas.aws.amazon.com/cve/html/CVE-2022-23037.html) \[`xen/netfront`: don't use `gnttab_query_foreign_access()` for mapped status\]  | 
|  [CVE\-2022\-23038](https://alas.aws.amazon.com/cve/html/CVE-2022-23038.html) \[`xen/grant-table`: add `gnttab_try_end_foreign_access()`\]  | 
|  [CVE\-2022\-23039](https://alas.aws.amazon.com/cve/html/CVE-2022-23039.html) \[`xen/gntalloc`: don't use `gnttab_query_foreign_access()`\]  | 
|  [CVE\-2022\-23040](https://alas.aws.amazon.com/cve/html/CVE-2022-23040.html) \[`xen/xenbus`: don't let `xenbus_grant_ring()` remove grants in error case\]  | 
|  [CVE\-2022\-23041](https://alas.aws.amazon.com/cve/html/CVE-2022-23041.html) \[`xen/9p`: use `alloc/free_pages_exact()`\]   | 
|  [CVE\-2022\-23042](https://alas.aws.amazon.com/cve/html/CVE-2022-23042.html) \[`xen/netfront`: react properly to failing `gnttab_end_foreign_access_ref()`\]  | 
|  [CVE\-2022\-23960](https://alas.aws.amazon.com/cve/html/CVE-2022-23960.html) \[`ARM`: report `Spectre v2` status through `sysfs`\]  | 
|  [CVE\-2022\-0995](https://alas.aws.amazon.com/cve/html/CVE-2022-0995.html) \[`watch_queue`: Fix filter limit check\]  | 
|  [CVE\-2022\-1011](https://alas.aws.amazon.com/cve/html/CVE-2022-1011.html) \[`fuse`: fix pipe buffer lifetime for `direct_io`\]  | 
|  [CVE\-2022\-27666](https://alas.aws.amazon.com/cve/html/CVE-2022-27666.html) \[`esp`: Fix possible buffer overflow in `ESP` transformation\]  | 
...
|  Add `out-of-tree smartpqi` driver Version `2.1.14-030` as external module under `drivers/amazon`  | 
...
# Amazon Linux 2022 packages updated 2022\-04\-19<a name="all-packages-al2022-20220419"></a>

The following list includes all packages for Amazon Linux 2022\.0\.20220419\.0 update released on April 19, 2022\.
...
There are 3483 source packages in AL2022\.
...
|  crash  |  8\.0\.0\-5\.amzn2022\.0\.1  | 
|  createrepo\_c  |  0\.17\.5\-1\.amzn2022\.0\.1  | 
...
|  mod\_http2  |  1\.15\.24\-1\.amzn2022\.0\.1  | 
...
|  rust\-asn1\_derive  |  0\.8\.7\-10\.amzn2022  | 
...
There are 1360 source packages in AL2022\.
...
|  amazon\-efs\-utils  |  1\.31\.2\-1\.amzn2  |  1\.31\.3\-2\.amzn2022  | 
...
|  aws\-kinesis\-agent  |  2\.0\.5\-1\.amzn2  |  2\.0\.7\-1\.amzn2022  | 
...
|  ca\-certificates  |  2021\.2\.50\-72\.amzn2\.0\.1  |  2021\.2\.50\-1\.0\.amzn2022\.0\.2  | 
...
|  cloud\-init  |  19\.3\-44\.amzn2  |  20\.4\-3\.amzn2022\.3\.0  | 
...
|  crash  |  7\.2\.9\-1\.amzn2\.0\.2  |  8\.0\.0\-5\.amzn2022\.0\.1  | 
...
|  cyrus\-sasl  |  2\.1\.26\-23\.amzn2  |  2\.1\.27\-9\.amzn2022  | 
...
|  dracut\-config\-ec2  |  2\.0\-2\.amzn2  |  3\.0\-3\.amzn2022  | 
...
|  ec2\-utils  |  1\.2\-45\.amzn2  |  2\.0\.1\-1\.amzn2022  | 
...
|  expat  |  2\.1\.0\-12\.amzn2  |  2\.4\.6\-1\.amzn2022  | 
...
|  freerdp  |  2\.1\.1\-2\.amzn2  |  2\.4\.1\-1\.amzn2022\.0\.1  | 
...
|  gcc  |  7\.3\.1\-13\.amzn2  |  11\.2\.1\-9\.amzn2022\.0\.1  | 
...
|  glibc  |  2\.26\-56\.amzn2  |  2\.34\-8\.amzn2022  | 
...
|  gnutls  |  3\.3\.29\-9\.amzn2  |  3\.7\.2\-2\.amzn2022\.0\.1  | 
...
|  grub2  |  2\.06\-2\.amzn2\.0\.6  |  2\.06\-22\.amzn2022\.0\.1  | 
...
|  httpd  |  2\.4\.51\-1\.amzn2  |  2\.4\.53\-3\.amzn2022\.0\.1  | 
...
|  libtiff  |  4\.0\.3\-35\.amzn2  |  4\.3\.0\-6\.amzn2022  | 
...
|  log4j  |  1\.2\.17\-16\.amzn2  |  2\.17\.1\-1\.amzn2022\.0\.1  | 
...
|  openssh  |  7\.4p1\-21\.amzn2\.0\.3  |  8\.6p1\-5\.amzn2022\.0\.1  | 
|  openssl  |  1\.0\.2k\-19\.amzn2\.0\.10  |  3\.0\.0\-1\.amzn2022\.0\.1  | 
...
|  polkit  |  0\.112\-26\.amzn2  |  0\.117\-3\.amzn2022\.2  | 
...
|  python\-pillow  |  2\.0\.0\-21\.gitd1c6db8\.amzn2\.0\.1  |  9\.0\.1\-6\.amzn2022\.0\.1  | 
...
|  samba  |  4\.10\.16\-15\.amzn2\.0\.1  |  4\.15\.5\-0\.amzn2022  | 
...
|  system\-release  |  2\-14\.amzn2  |  2022\.0\.20220419\-1\.amzn2022  | 
...
|  tzdata  |  2021a\-1\.amzn2  |  2022a\-1\.amzn2022  | 
...
|  vim  |  8\.2\.3642\-1\.amzn2\.0\.1  |  8\.2\.4314\-1\.amzn2022  | 
...
|  xorg\-x11\-server  |  1\.20\.4\-15\.amzn2\.0\.2  |  1\.20\.11\-1\.amzn2022\.0\.1  | 
...
|  zsh  |  5\.7\.1\-6\.amzn2\.0\.1  |  5\.8\.1\-1\.amzn2022\.0\.1  | 
|  zstd  |  1\.3\.3\-1\.amzn2\.0\.1  |  1\.5\.2\-1\.amzn2022  | 
...
There are 2123 packages new to AL2022\.
...
There are 1339 packages that were in AL2 that are not a part of AL2022\.
