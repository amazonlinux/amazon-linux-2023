...
## Major updates<a name="major-updates-20221103"></a>
...
This release includes changes to the packages and package versions that are used in Amazon Linux 2022\.0\.20221103\. Some packages from Amazon Linux 2 aren't used in Amazon Linux 2022, some packages are new for Amazon Linux 2022, and some packages that were present in Amazon Linux 2 use new versions in Amazon Linux 2022\.
...
There are 1343 updated packages in Amazon Linux 2022\.
...
|  `ecs-init`  |  `1.64.0-1.amzn2`  |  `1.65.0-1.amzn2022`  | 
...
|  `libtiff`  |  `4.0.3-35.amzn2.0.2`  |  `4.4.0-4.amzn2022.0.1`  | 
...
|  `system-release`  |  `2-14.amzn2`  |  `2022.0.20221103-0.amzn2022`  | 
|  `systemd`  |  `219-78.amzn2.0.20`  |  `250.8-1.amzn2022.0.3`  | 
...
|  `tzdata`  |  `2022e-1.amzn2.0.1`  |  `2022f-1.amzn2022.0.1`  | 
...
There are 1546 packages that were in Amazon Linux 2 that are not a part of Amazon Linux 2022\.
