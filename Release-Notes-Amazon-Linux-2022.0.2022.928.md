...
| `adcli` | `0.8.1-16.amzn2.1.0.1` | `0.9.1-10.amzn2022.0.1` | 
...
| `alsa-lib` | `1.1.4.1-2.amzn2` | `1.2.7.2-1.amzn2022` | 
| `alsa-plugins` | `1.1.1-1.amzn2.0.2` | `1.2.7.1-1.amzn2022.0.1` | 
| `alsa-utils` | `1.1.3-2.amzn2.0.1` | `1.2.7-1.amzn2022.0.1` | 
| `amazon-cloudwatch-agent` | `1.247354.0b251981-1.amzn2` | `1.247354.0b251981-1.amzn2022` | 
| `amazon-efs-utils` | `1.33.3-1.amzn2` | `1.33.2-1.amzn2022` | 
...
| `automake` | `1.13.4-3.1.amzn2` | `1.16.5-9.amzn2022.0.1` | 
...
| `aws-kinesis-agent` | `2.0.6-1.amzn2` | `2.0.8-2.amzn2022` | 
...
| `bcc` | `0.24.0-3.amzn2.0.4` | `0.24.0-2.amzn2022.0.1` | 
| `bcc` | `0.10.0-1.amzn2.0.1` | `0.24.0-2.amzn2022.0.1` | 
| `bcel` | `5.2-18.amzn2` | `6.4.1-5.amzn2022` | 
| `beust-jcommander` | `1.30-5.amzn2` | `1.78-5.amzn2022` | 
| `bind` | `9.11.4-26.P2.amzn2.5.2` | `9.16.27-1.amzn2022` | 
...
| `bpftrace` | `0.12.1-2.amzn2.0.1` | `0.15.0-1.amzn2022` | 
...
| `chrony` | `4.2-5.amzn2.0.2` | `4.2-7.amzn2022.0.2` | 
...
| `clamav` | `0.103.6-1.amzn2.0.1` | `0.103.7-1.amzn2022.0.1` | 
| `clang` | `11.1.0-1.amzn2.0.2` | `14.0.5-2.amzn2022.0.3` | 
| `cloud-init` | `19.3-45.amzn2` | `22.2.2-1.amzn2022.1.4` | 
...
| `dnf` | `4.0.9.2-1.amzn2.0.1` | `4.12.0-2.amzn2022.0.1` | 
...
| `dracut` | `033-535.amzn2.1.6` | `055-6.amzn2022.0.4` | 
...
| `ecs-init` | `1.62.2-1.amzn2` | `1.63.1-1.amzn2022` | 
...
| `fio` | `2.14-1.amzn2.0.2` | `3.32-2.amzn2022.0.1` | 
...
| `gcc` | `7.3.1-15.amzn2` | `11.3.1-2.amzn2022.0.6` | 
| `gcr` | `3.28.0-1.amzn2` | `3.40.0-1.amzn2022` | 
| `gd` | `2.0.35-27.amzn2` | `2.3.3-5.amzn2022.0.1` | 
| `gdb` | `8.0.1-36.amzn2.0.1` | `12.1-5.amzn2022` | 
...
| `gmp` | `6.0.0-15.amzn2.0.2` | `6.2.1-2.amzn2022` | 
| `gnu-efi` | `3.0.8-4.amzn2.0.1` | `3.0.11-9.amzn2022` | 
| `gnupg2` | `2.0.22-5.amzn2.0.5` | `2.3.7-1.amzn2022.0.1` | 
| `gnuplot` | `4.6.2-3.amzn2.0.2` | `5.4.3-3.amzn2022.0.1` | 
| `gnutls` | `3.3.29-9.amzn2.0.1` | `3.7.2-2.amzn2022.0.1` | 
| `go-rpm-macros` | `3.0.15-23.amzn2.0.1` | `3.1.0-30.amzn2022` | 
| `gobject-introspection` | `1.56.1-1.amzn2` | `1.73.0-2.amzn2022` | 
| `golang` | `1.18.3-1.amzn2` | `1.19.1-1.amzn2022.0.1` | 
| `golang` | `1.11.13-2.amzn2.0.1` | `1.19.1-1.amzn2022.0.1` | 
| `golist` | `0.10.1-6.amzn2.0.1` | `0.10.1-11.amzn2022` | 
...
| `grep` | `2.20-3.amzn2.0.2` | `3.8-1.amzn2022.0.1` | 
...
| `highlight` | `3.13-3.amzn2.0.2` | `4.2-2.amzn2022.0.1` | 
...
| `java-11-amazon-corretto` | `11.0.16+9-1.amzn2` | `11.0.16+8-2.amzn2022` | 
| `java-17-amazon-corretto` | `17.0.4+9-1.amzn2.1` | `17.0.4+8-2.amzn2022.1` | 
...
| `kernel` | `4.14.291-218.527.amzn2` | `5.15.57-30.131.amzn2022` | 
| `kernel` | `5.10.130-118.517.amzn2` | `5.15.57-30.131.amzn2022` | 
| `kernel` | `5.4.209-116.367.amzn2` | `5.15.57-30.131.amzn2022` | 
| `kernel` | `5.10.135-122.509.amzn2` | `5.15.57-30.131.amzn2022` | 
| `kernel` | `5.15.59-33.133.amzn2` | `5.15.57-30.131.amzn2022` | 
...
| `kpatch` | `0.9.4-3.amzn2` | `0.9.4-7.amzn2022` | 
...
| `liblognorm` | `2.0.2-1.amzn2.0.2` | `2.0.6-1.amzn2022.0.1` | 
...
| `libpq` | `12.11-1.amzn2.0.1` | `13.4-1.amzn2022.0.1` | 
| `libpq` | `13.3-1.amzn2` | `13.4-1.amzn2022.0.1` | 
| `libpq` | `14.3-2.amzn2.0.2` | `13.4-1.amzn2022.0.1` | 
...
| `lz4` | `1.7.5-2.amzn2.0.1` | `1.9.4-1.amzn2022` | 
...
| `mcstrans` | `0.3.4-5.amzn2.0.2` | `3.2-3.amzn2022.0.1` | 
...
| `ocaml` | `4.05.0-6.amzn2` | `4.13.1-4.amzn2022` | 
| `ocaml-findlib` | `1.7.3-7.amzn2` | `1.9.3-2.amzn2022.0.1` | 
| `ocaml-ocamlbuild` | `0.11.0-9.amzn2` | `0.14.0-32.amzn2022.0.1` | 
| `ocaml-srpm-macros` | `5-2.amzn2` | `6-6.amzn2022` | 
...
| `perl-DBD-Pg` | `2.19.3-4.amzn2.0.2` | `3.14.2-3.amzn2022.0.1` | 
...
| `postgresql` | `9.2.24-8.amzn2` | `13.7-1.amzn2022.0.4` | 
| `postgresql` | `9.6.22-1.amzn2.0.1` | `13.7-1.amzn2022.0.4` | 
| `postgresql` | `10.21-1.amzn2.0.1` | `13.7-1.amzn2022.0.4` | 
| `postgresql` | `11.16-1.amzn2.0.1` | `13.7-1.amzn2022.0.4` | 
| `postgresql` | `12.11-3.amzn2.0.2` | `13.7-1.amzn2022.0.4` | 
| `postgresql` | `13.7-2.amzn2.0.1` | `13.7-1.amzn2022.0.4` | 
| `postgresql` | `14.3-2.amzn2.0.1` | `13.7-1.amzn2022.0.4` | 
...
| `pygobject3` | `3.22.0-1.amzn2.1` | `3.42.2-2.amzn2022` | 
...
| `python-bottle` | `0.12.21-2.amzn2` | `0.12.18-3.amzn2022` | 
...
| `qpdf` | `5.0.1-3.amzn2.0.2` | `10.6.3-4.amzn2022.0.1` | 
...
| `realmd` | `0.16.1-9.amzn2.0.1` | `0.17.0-9.amzn2022.0.1` | 
...
| `rpm` | `4.11.3-48.amzn2.0.2` | `4.16.1.3-12.amzn2022.0.2` | 
| `rpm` | `4.14.3-4.amzn2.0.1` | `4.16.1.3-12.amzn2022.0.2` | 
...
| `sendmail` | `8.14.7-5.amzn2.0.1` | `8.17.1-5.amzn2022.0.2` | 
...
| `slang` | `2.2.4-11.amzn2.0.2` | `2.3.2-9.amzn2022.0.1` | 
...
| `system-release` | `2-14.amzn2` | `2022.0.20220928-0.amzn2022` | 
| `systemd` | `219-78.amzn2.0.18` | `250.8-1.amzn2022.0.1` | 
...
| `tzdata` | `2022c-1.amzn2` | `2022c-1.amzn2022.0.1` | 
...
| `vim` | `8.2.5172-1.amzn2.0.1` | `9.0.327-1.amzn2022.0.1` | 
| `vim` | `8.0.1257-2.amzn2` | `9.0.327-1.amzn2022.0.1` | 
| `volume_key` | `0.3.9-8.amzn2` | `0.3.12-14.amzn2022` | 
| `vorbis-tools` | `1.4.0-13.amzn2` | `1.4.2-2.amzn2022` | 
| `vsftpd` | `3.0.2-25.amzn2` | `3.0.5-1.amzn2022` | 
...
There are 898 packages new for Amazon Linux 2022\.
...
There are 1545 packages that were in Amazon Linux 2 that are not a part of Amazon Linux 2022\.
