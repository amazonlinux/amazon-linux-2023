...
This release includes changes to the packages and package versions that are used in Amazon Linux 2022\.0\.20220831\. Some packages from Amazon Linux 2 aren't used in Amazon Linux 2022, some packages are new for Amazon Linux 2022, and some packages that were present in Amazon Linux 2 use new versions in Amazon Linux 2022\.
...
There are 1338 updated packages in Amazon Linux 2022\.
...
| `amazon-cloudwatch-agent` | `1.247352.0-1.amzn2` | `1.247354.0b251981-1.amzn2022` | 
...
| `bcc` | `0.18.0-1.amzn2.0.3` | `0.24.0-2.amzn2022.0.1` | 
...
| `bpftrace` | `0.12.1-1.amzn2.0.1` | `0.15.0-1.amzn2022` | 
...
| `cloud-init` | `19.3-45.amzn2` | `22.2.2-1.amzn2022.1.2` | 
...
| `ecs-init` | `1.62.1-1.amzn2` | `1.62.2-1.amzn2022` | 
...
| `golang` | `1.18.3-1.amzn2` | `1.19-1.amzn2022.0.1` | 
| `golang` | `1.11.13-2.amzn2.0.1` | `1.19-1.amzn2022.0.1` | 
...
| `kernel` | `4.14.290-217.505.amzn2` | `5.15.57-30.131.amzn2022` | 
| `kernel` | `5.10.130-118.517.amzn2` | `5.15.57-30.131.amzn2022` | 
| `kernel` | `5.4.209-116.363.amzn2` | `5.15.57-30.131.amzn2022` | 
| `kernel` | `5.10.135-122.509.amzn2` | `5.15.57-30.131.amzn2022` | 
| `kernel` | `5.15.57-29.131.amzn2` | `5.15.57-30.131.amzn2022` | 
...
| `microcode_ctl` | `2.1-47.amzn2.0.12` | `2.1-53.amzn2022` | 
...
| `system-release` | `2-14.amzn2` | `2022.0.20220831-0.amzn2022` | 
| `systemd` | `219-78.amzn2.0.18` | `250.7-1.amzn2022.0.6` | 
...
| `tzdata` | `2022a-1.amzn2` | `2022c-1.amzn2022.0.1` | 
...
There are 1550 packages that were in Amazon Linux 2 that are not a part of Amazon Linux 2022\.
